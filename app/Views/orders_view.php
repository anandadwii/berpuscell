        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="addOrder" type="button" class="btn btn-outline-primary">
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('admin/editOrder/' . $row['invoice']) ?>" class="btn btn-outline-primary" type="button">
                                        <span data-feather="edit-3"></span>
                                        Edit
                                    </a>
                                    <a href="<?= base_url('admin/deleteOrder/' . $row['invoice']) ?>" class="btn btn-outline-danger" type="button">
